...
public:
    ...
    void SetSettings(const renderer::Setting &setting);

    std::optional<BestRouteInfo> MakeRoute(const std::string &from, const std::string &to);

    void SetRouteSettings(int wait_time, int velocity);

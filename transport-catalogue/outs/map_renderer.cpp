...
namespace renderer
{
    ...
    void MapRenderer::SetSettings(const Setting &setting)
    {
    ...
    void MapRenderer::RenderMap(svg::Document &document, std::vector<const Route *> routs)
    {
        ...
        for (const auto &route_ptr : routs)
        {
            ...
            route_line.SetFillColor("none").SetStrokeColor(*line_color_ptr).SetStrokeWidth(render_setting_.line_width).SetStrokeLineCap(svg::StrokeLineCap::ROUND).SetStrokeLineJoin(svg::StrokeLineJoin::ROUND);
        ...
        {
            svg::Text route_name;
            route_name.SetPosition(projector(end_stop->coordinates)).SetOffset(render_setting_.bus_label_offset).SetFontSize(render_setting_.bus_label_font_size).SetFontFamily("Verdana").SetFontWeight("bold").SetData(name);
            svg::Text route_name_underlayer = route_name;
            route_name.SetFillColor(color);
            route_name_underlayer.SetFillColor(render_setting_.underlayer_color).SetStrokeColor(render_setting_.underlayer_color).SetStrokeWidth(render_setting_.underlayer_width).SetStrokeLineCap(svg::StrokeLineCap::ROUND).SetStrokeLineJoin(svg::StrokeLineJoin::ROUND);
        ...
        for (const auto &stop : stops_list)
        {
            ...
            stop_circle.SetCenter(projector(stop->coordinates)).SetRadius(render_setting_.stop_radius).SetFillColor("white");
        ...
        {
            svg::Text stop_name;
            stop_name.SetPosition(projector(stop->coordinates)).SetOffset(render_setting_.stop_label_offset).SetFontSize(render_setting_.stop_label_font_size).SetFontFamily("Verdana").SetData(stop->name);
            svg::Text stop_name_underlayer = stop_name;
            stop_name.SetFillColor("black");
            stop_name_underlayer.SetFillColor(render_setting_.underlayer_color).SetStrokeColor(render_setting_.underlayer_color).SetStrokeWidth(render_setting_.underlayer_width).SetStrokeLineCap(svg::StrokeLineCap::ROUND).SetStrokeLineJoin(svg::StrokeLineJoin::ROUND);
